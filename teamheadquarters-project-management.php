...
<head>
    ...
    <title>TeamHeadquarters Project Management | Entry Software Corporation</title>
    <meta name="description" content="TeamHeadquarters Project Management Solution for IT">
    <meta name="robots" content="noindex, nofollow">
    <link href="css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="css/style.min.css" rel="stylesheet" type="text/css" />
    <link href="css/style-sandbox.min.css" rel="stylesheet" type="text/css" />
    <link rel="canonical" href="http://www.entry.com/project-management.php" />
...
<body>
    ...
    <?php include 'includes/google.html';?>
        <?php include 'includes/navbar.php';?>
            <div class="container-fluid" style="background-image: url('img/project-team.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center; width: 100%; height: 100%; !important; min-height:100%;">
                <div style="max-width: 80%; text-align: center; display: block; margin-left: auto; margin-right: auto; background-color: white; opacity: .7; border-radius: 5px; margin-top: 20%; padding: 25px;"">
                    ...
                    <h1 style="text-align: center; color: #000;">A Project Management System Perfected for the Small and Medium-sized Company</h1>
                ...
                <div class="container">
                    <div class="row" style="padding-bottom: 30px;">
                        <div class="col-md-4" style="padding-top: 50px;">
                            <div class="thumbnail" style="width: 75%; display: block; margin-left: auto; margin-right: auto; padding: 15px;">
                                <img class="media-object img-responsive" src="img/help-desk-icon.jpg" alt="project management" width="75" height="75">
                                <h3 style="text-align: center;">Integrated Help Desk</h3>
                                <p style="text-align: center;">No need to integrate with a Help Desk system, <strong>TeamHeadquarters Help Desk is included in every solution!</strong></p>
                            </div>
                        </div>
                        <div class="col-md-4"  style="padding-top: 50px;">
                            <div class="thumbnail" style="width: 75%; display: block; margin-left: auto; margin-right: auto; padding: 15px;">
                                <img class="media-object img-responsive" src="img/resource-management.png" alt="resource management" width="75" height="75">
                                <h3 style="text-align: center;">Team<br>Management</h3>
                                <p style="text-align: center;">Understand the entire team's workload, <strong>TeamHeadquarters MyTeams is included!</strong></p>
                            </div>
                        </div>
                        <div class="col-md-4" style="padding-top: 50px;">
                            <div class="thumbnail" style="width: 75%; display: block; margin-left: auto; margin-right: auto; padding: 15px;">
                                <img class="media-object img-responsive" src="img/scheduling.gif" alt="scheduling" width="75" height="75">
                                <h3 style="text-align: center;">Scheduling</h3>
                                <p style="text-align: center;">Schedule all your work assignments and activities. <strong>Integration with Exchange and Google built-in!</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row" style="padding-bottom: 30px; padding-top: 30px;">
                        <div class="col-md-6">
                            ...
                            <ul style="list-style: square; font-size: 1.25em;">
                                <li>Understand resource availability and workload.</li>
                                <li>Just view project and support loads by resource or by a team.</li>
                                <li>Access the team's project tasks and support tickets.</li>
                                <li>Report on activities across the team.</li>
                            </ul>
                            <blockquote class="well" style="background-color: lemonchiffon;">
                    ...
                    <div class="row" style="padding-bottom: 30px;">
                        <div class="col-md-6">
                            ...
                            <ul style="list-style: square; font-size: 1.25em;">
                                ...
                                <li>Integration with Microsoft Exchange and Google Calendar.</li>
                            </ul>
                            <blockquote class="well" style="background-color: lemonchiffon;">
                        ...
                        <div class="col-md-6"><img src="/img/thq-my-teams-dashboard.png" style="border: solid 1px silver; padding: 5px; max-height: 100%; max-width: 100%;" alt="TeamHeadquarters integrated calendar with incidents and project tasks"></div>
                    </div> 
            </div>
            </div>
