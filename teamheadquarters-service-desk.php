...
<head>
    ...
    <title>TeamHeadquarters Service Desk | Entry Software Corporation</title>
    ...
    <link rel="canonical" href="http://www.entry.com/service-desk.php" />
    ...
    <?php include 'includes/google.html';?>
        <?php include 'includes/navbar.php';?>
                    ...
                    <div class="row" style="padding-bottom: 10px;">
                        <div class="col-md-4" style="padding-top: 50px;">
                            <div class="thumbnail" style="width: 75%; display: block; margin-left: auto; margin-right: auto; padding: 15px;">
                                <img class="media-object img-responsive" src="img/project-management.png" alt="project management" width="75" height="75">
                                <h3 style="text-align: center;">Integrated Project Management</h3>
                                <p style="text-align: center;">No need to integrate with a project management system, <strong>TeamHeadquarters Project Management is included in every solution!</strong></p>
                            </div>
                        </div>
                        <div class="col-md-4"  style="padding-top: 50px;">
                            <div class="thumbnail" style="width: 75%; display: block; margin-left: auto; margin-right: auto; padding: 15px;">
                                ...
                                <p style="text-align: center;">Schedule service requests, project tasks and work events. <strong>With TeamHeadquarters you will understand the team's workload, it's built-in!</strong></p>
                            </div>
                        </div>
                        <div class="col-md-4" style="padding-top: 50px;">
                            <div class="thumbnail" style="width: 75%; display: block; margin-left: auto; margin-right: auto; padding: 15px;">
                                <img class="media-object img-responsive" src="img/scheduling.gif" alt="scheduling" width="75" height="75">
                                <h3 style="text-align: center;">Scheduling and Calendars</h3>
                                <p style="text-align: center;">Plan and schedule all your work assignments and activities in TeamHeadquarters. <strong>Integration with Exchange and Google Calendar!</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                    <div class="row" style="padding-top: 30px;">
                        <div class="col-md-6">
                           ...
                           <ul style="list-style: square; font-size: 1.25em;">
                            ...
                            <blockquote class="well" style="background-color: lightcyan;">
                    ...
                    <div class="row" style="padding-top: 30px; padding-bottom: 30px;">
                        <div class="col-md-6">
                            <h2 style="text-align: center;">Integrated Service Desk Functionality</h2>
                            
                            <ul style="list-style: square; font-size: 1.25em;">
                                <li>Incident and Problem Management  for your small business or enterprise.</li>
                                <li>Access to real-time dashboards for reporting.</li>
                                <li>Customer Self Service Portal to facilitate incident requests and routing of service tickets.</li>
                            </ul>
                            <blockquote class="well" style="background-color: lightcyan;">
                                "TeamHeadquarters is the only solution that we found that could do projects, helpdesk and resource management in an easy to deploy and learn SaaS implementation."
                                <small>Michelle Dunn, CIO Trine University</small>
